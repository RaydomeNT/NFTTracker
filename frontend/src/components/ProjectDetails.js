    ...
    <div className="project-details">
      {isEditing ? (
        ...
        <div>
          ...
          <button className="editSaveButton" onClick={handleSave}>Save</button>
        </div>
      ) : (
        ...
        <>
          ...
          <p>
            ...
            {format(new Date(project.date), "do MMM yyyy", { locale: enGB })}
          </p>
          <p>
            <strong>Mint Time: </strong>
            {project.time}
          </p>
          <p>
          ...
          <p>
            <strong>Wallet Submitted: </strong>
            {project.walletSub}
          </p>
          <p>
          ...
          <p>
            ...
            <a href={project.twitterLink}>{project.twitterLink}</a>
          </p>
          <p>
